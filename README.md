...
# A lightweight C++ implementation is included and can be built from the cpp directory with the following command 

# g++ -O2 -std=c++17 -o popout src/main.cpp src/pop_data.cpp src/stats.cpp

# Run command: ./popout data/*.pop --out cpp --regRange 100
# Produces output: cpp-popout.txt 



#C) A lightweight RScript can also be called 
